...
function GUILibrary:CreateMainGUI(titleText)
    ...
    -- Permanent "Created by Scarlet Script" label in the top-left corner
    local permanentLabel = Instance.new("TextLabel")
    permanentLabel.Size = UDim2.new(0, 150, 0, 20) -- Adjust size for better appearance
    permanentLabel.Position = UDim2.new(0, 10, 0, 10) -- Positioned in the top-left corner
    permanentLabel.AnchorPoint = Vector2.new(0, 0) -- Anchor to the top-left
    permanentLabel.Text = "Created by Scarlet Script"
    permanentLabel.Font = Enum.Font.Gotham
    permanentLabel.TextSize = 10  -- Small text size
