...
function GUILibrary:CreateMainGUI(titleText)
    ...
    -- Permanent "Created by Scarlet Script" label above the main frame
    local permanentLabel = Instance.new("TextLabel")
    permanentLabel.Size = UDim2.new(1, 0, 0, 20)
    permanentLabel.Position = UDim2.new(0.5, -200, 0, -30) -- Positioned above the main frame
    permanentLabel.AnchorPoint = Vector2.new(0.5, 1) -- Centered horizontally
